...
const ProjectOverviewChart2 = () => {
    ...
    const dataSeries = (seriesType) => {
        ...
        setSeries([
            { name: "Number of Projects", type: 'column', data: columnData },
            { name: "Revenue", type: 'area', data: areaData },
            { name: "Active Projects", type: 'line', data: lineData }
        ]);
    }
        ...
        <>
            <Tab.Container defaultActiveKey={'Week'}>
                <div className="card-header border-0 pb-0 flex-wrap">
                    <h4 className="card-title mb-0">Patient by Department</h4>
                    <Nav as="ul" className="nav nav-pills mix-chart-tab revenue-tab">
                        {chartHeaderData.map((item, index) => (
                            <Nav.Item as="li" className="nav-item" key={index}>
                                <Nav.Link eventKey={item.title} onClick={() => dataSeries(item.type)}>
                                    {item.title}
                                </Nav.Link>
                            </Nav.Item>
                        ))}
                ...
                <div className="card-body p-0">
                    ...
                    <div className="ttl-project">
                        ...
                        <div className="pr-data">
                            <h5 className="text-primary">521</h5>
                        ...
                        <div className="pr-data">
                            <h5 className="text-success">275</h5>
...
export default ProjectOverviewChart2;
