...
const UiAlert = () => {
  ...
  return (
    <Fragment>
      <PageTitle motherMenu="Home" activeMenu="Alert" pageContent="Alert" />
        ...
        <div className="element-wrapper">
          <div className="element-right">
            <div className="p-4 border-bottom">
              ...
              <Link to={"#"} className="btn btn-primary">Alert on Bootstrap</Link>
            </div>
            <div className="demo-right-inner dz-scroll " id="right-sidebar">
              <AlertList />
            </div>
          </div>
                        ...
                        <Tab.Pane eventKey="Preview">
                          <Card.Body>
                            ...
                            <Alert variant="success" dismissible show={state.solidsucces} className="solid">
                              {emojis.success}
                              {" "}  <strong>Success!</strong> Message has been sent.
                              <button className="btn-close" onClick={() => dispatch({ type: 'solidsucces' })}><span><i className="fa-solid fa-xmark" /></span></button>
                            </Alert>
