        ...
        <div className="element-wrapper">
          <div className="element-right">
            <div className="p-4 border-bottom">
              <h2>Dropdown.</h2>
              <p>Make use of Bootstrap's unique Dropdown styles to enhance actions in forms, dialogs, and various other elements, featuring comprehensive support for multiple sizes, states, and additional functionalities.</p>
              <Link to={"#"} className="btn btn-primary">Dropdown on Bootstrap</Link>
            </div>
                    ...
                    <Card name="dropdown-divider" className="dz-card">
                      <Card.Header className="flex-wrap">
                        <div>
                          ...
                          <Card.Text className="m-0 subtitle">
                            The <code>.dropdown-divider</code> class is used to separate links inside the dropdown menu. 
                          </Card.Text>
                        </div>
                        <Nav as="ul" className="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                          <Nav.Item as="li" className="nav-item" role="presentation">
                            ...
                            <Row>
                              ...
                              <Col xl={3}>
                                <Dropdown className="custom-dropdown">
                                  ...
                                  >
                                    <i className="ti-search me-2 mt-1" /> 3 AM
                              ...
                              <Col xl={3}>
                                <Dropdown className="custom-dropdown">
                                  ...
                                  >
                                    <i className="ti-calendar me-3" /> March 20, 2018 &nbsp; To &nbsp;April
                                    20, 2018
                                    <i className="fa fa-angle-down ms-3" />
                                  </Dropdown.Toggle>
                                  <Dropdown.Menu>
