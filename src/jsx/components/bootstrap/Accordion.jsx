...
const UiAccordion = () => {
  ...
  return (
    <Fragment>
      <PageTitle activeMenu="Accordion" motherMenu="Home" pageContent="Accordion" />
        ...
        <div className="element-wrapper">
          <div className="element-right">
            <div className="p-4 border-bottom">
              ...
              <Link to={"#"} className="btn btn-primary">Accordion on Bootstrap</Link>
            </div>

            <div className="demo-right-inner navigation navbar" id="right-sidebar">
                          ...
                          <Card.Body className="card-body">
                            <Accordion className="accordion accordion-primary" defaultActiveKey="0">
                              {defaultAccordion.map((d, i) => (
                                <Accordion.Item className="" key={i} eventKey={`${i}`}>
