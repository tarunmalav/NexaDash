...
const UiModal = () => {
  ...
  return (
	<>
		  ...
		  {/* <!-- Modal --> */}
			<Modal className="fade" show={state.basicModal} onHide={()=>dispatch({type:'basicModal'})} centered>
				<Modal.Header>
			...
			{/* <!-- Modal --> */}
			<Modal className="fade" show={state.contentModal} onHide={()=>dispatch({type:'contentModal'})} centered>
				<Modal.Header>
					<Modal.Title>Modal title</Modal.Title>
			...
			{/* <!-- Modal --> */}
			<Modal className="fade" show={state.gridInsideModal} onHide={()=>dispatch({type:'gridInsideModal'})} centered>
				<Modal.Header>
					<Modal.Title>Modal title</Modal.Title>
			...
			{/* large modal */}
			<Modal className="fade bd-example-modal-lg" show={state.largeModal} size="lg" onHide={()=>dispatch({type:'largeModal'})} centered> 
				<Modal.Header>
					<Modal.Title>Modal title</Modal.Title>
			...
			{/* smallModal */}	
			<Modal className="fade bd-example-modal-sm" size="sm" show={state.smallModal} onHide={()=>dispatch({type:'smallModal'})} centered>
			  <Modal.Header>
				<Modal.Title>Modal title</Modal.Title>
				<Button
				  variant=""
