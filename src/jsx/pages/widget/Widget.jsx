                    ...
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2">
                          <img  alt="" width="50" src={IMAGES.avtar1jpg} />
                        </div>
                ...
                >
                  <ul className="timeline">
                    ...
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2 media-success">
                          <img  alt="" width="50" src={IMAGES.avtar2jpg} />
                        </div>
                        <div className="media-body">
                          <h5 className="mb-1">
                            Jack Ronan{" "}
                    ...
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2 media-primary">
                          <img  alt="" width="50" src={IMAGES.avtar3jpg} />
                        </div>
                        <div className="media-body">
                          <h5 className="mb-1">
                            Oscar Weston{" "}
                ...
                <div className="widget-media">
                  <ul className="timeline">
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2">
                          <img  alt="" width="50" src={IMAGES.avtar4jpg} />
                        </div>
                        <div className="media-body">
                          <h5 className="mb-1">Dr sultads Send you Photo</h5>
                          <small className="d-block">
                    ...
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2 media-info">
                          <img  width="50" alt="" src={IMAGES.avtar1jpg} />
                        </div>
                        <div className="media-body">
                          <h5 className="mb-1">Resport created successfully</h5>
                          <small className="d-block">
                    ...
                    <li>
                      <div className="timeline-panel">
                        <div className="media me-2 media-success">
                          <img  width="50" alt="" src={IMAGES.avtar3jpg} />
                        </div>
                        <div className="media-body">
                          <h5 className="mb-1">Reminder : Treatment Time!</h5>
                          <small className="d-block">
