            ...
            <div className="row">
                <div className="col-xl-12">
                    <div>
                        ...
                        <button type="submit" className="btn btn-primary mb-3 open" onClick={() => dispatch({ type: 'collpase0' })} >Screen Option</button>
                    </div>
                                ...
                                {screenOption.map((item, ind) => (
                                    <div className="col-xl-2 col-lg-3 col-sm-4" key={ind}>
                                        <div className="form-check mb-sm-3 mb-1">
                                            <input className="form-check-input" type="checkbox" value="" id={`flexCheckDefault-${item.series}`} onChange={() => { dispatch({ type: `section${item.id}` }) }} defaultChecked />
                            ...
                            {!state.section4 &&
                                <div className="filter cm-content-box box-primary">
                                    <div className="content-title" onClick={() => dispatch({ type: 'collpase11' })}>
                                        ...
                                        <div className="tools">
                                            <Link to={"#"} className={`SlideToolHeader ${state.collpase11 ? 'collapse' : 'expand'}`} >
                                                <i className="fas fa-angle-up" />
                                            </Link>
                                        </div>
                                    </div>
                                            ...
                                            <div className="card-body pb-0">
                                                <div className="accordion-item">
                                                    <ul className="d-flex align-items-center mb-2">
                                                        <li><Link to={"#"}><i className="fas fa-key" /></Link></li>
                                                        <li><Link to={"#"} className="ms-2">Status:</Link></li>
                                                        <li><strong><Link to={"#"} className="mx-2">Published</Link></strong></li>
                                                        <li>
                                                            <Link to={"#"} className="badge badge-primary light ms-3" onClick={() => dispatch({ type: 'collpase7' })} >  
                                                                Edit
                                                            </Link>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div className="accordion-item">
                                                    <ul className="d-flex align-items-center mb-2">
                                                        <li><Link to={"#"}><i className="fa fa-fw fa-eye" /></Link></li>
                                                        <li><Link to={"#"} className="ms-2">Status:</Link></li>
                                                        <li><strong><Link to={"#"} className="mx-2">Public</Link></strong></li>
                                                        <li>
                                                            <Link to={"#"} className="badge badge-primary light ms-3"
                                                ...
                                                <div className="avatar-upload d-flex align-items-center">
                                                    <div className=" position-relative ">
                                                        <div className="avatar-preview">
                                                            <div id="imagePreview" style={{ backgroundImage: file ? "url(" + URL.createObjectURL(file) + ")" : "url(" + NoImage + ")" }} > </div>
                                                        </div>
