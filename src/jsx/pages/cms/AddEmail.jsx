        ...
        <>
            <div className="row">
                <div className="col-xl-12">
                    <Link to={"/email-template"} type="submit" className="btn btn-primary mb-4">List Email Template</Link>
                </div>
                <div className="col-xl-12">
                    <div className="filter cm-content-box box-primary">
                        <div className="content-title SlideToolHeader" onClick={() => setCollapseBtn(!collapseBtn)}>
                            <div className="cpa">
